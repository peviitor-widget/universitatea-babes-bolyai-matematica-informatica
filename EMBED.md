...
**Facultate:** Facultatea de Matematică și Informatică, Universitatea Babeș-Bolyai

**Pagina widgetului:** https://peviitor-widget.github.io/universitatea-babes-bolyai-matematica-informatica/

Copiază codul de mai jos în pagina site-ului facultății, acolo unde vrei să apară widgetul:

```html
<iframe
  src="https://peviitor-widget.github.io/universitatea-babes-bolyai-matematica-informatica/#/widget?title=Joburi+pentru+studenti&color=%234f46e5"
  width="100%"
  height="650px"
